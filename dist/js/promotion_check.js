                ...
                $promotion.each(function () {
                    ...
                    if (promo_discount != "") {
                        ...
                        if (prod_id === product_id) {
                            count = count + 1;
                            $("#temp").append('<tr id = "row-' + count + '"><td><span id="pricecomp-' + count + '">' + text + '</span></td>  <td style="display: none" class="feetype"  data-feetype="' + fee_type + '" ></td><td style="display: none" class="grade"  data-grade="' + grade + '" ></td><td style="display: none" class="year"  data-year="' + year + '" ></td><td style="display: none" class="ocategory"  data-ocategory="' + ocategory + '" ></td><td style="display: none" class="location"  data-location="' + location + '" ></td><td class="text-align-right"><span id="price-' + count + '">' + fee + '</span></td>   <td style="display: none" class="pservice"  data-pservice="' + pservice + '" ></td> <td style="display: none" class="chartered"  data-chartered="' + chartered + '" ></td> <td style="display: none" class="cduration"  data-cduration="' + cduration + '" ></td><td style="display: none" class="register"  data-register="' + register + '" ></td> <td style="display: none" class="mra"  data-mra="' + mra + '" ></td><td style="display: none" class="invited"  data-invited="' + invited + '" ></td> <td style="display: none" class="member"  data-member="' + member + '" ></td><td class="text-align-right"><span id="price-dis-' + count + '">' + discounted_fee + '</span></td><td style="display: none" class="member text-align-center"  data-member="' + member + '" ></td><td class="text-align-center"><label class="container-checkbox pull-right check-outer' + count + '" id="checklabel-' + count + '"><input id ="' + count + '" type="checkbox" checked="checked"><span class="checkmark"></span></label></td></tr>');
                            $('#counter').text(count);
                        }
                    }
                    else {
                        ...
                        if (prod_id === product_id) {
                            count = count + 1;
                            $("#temp").append('<tr id = "row-' + count + '"><td><span id="pricecomp-' + count + '">' + text + '</span></td>  <td style="display: none" class="feetype"  data-feetype="' + fee_type + '" ></td><td style="display: none" class="grade"  data-grade="' + grade + '" ></td><td style="display: none" class="year"  data-year="' + year + '" ></td><td style="display: none" class="ocategory"  data-ocategory="' + ocategory + '" ></td><td style="display: none" class="location"  data-location="' + location + '" ></td><td class="text-align-right"><span id="price-' + count + '">' + fee + '</span></td>   <td style="display: none" class="pservice"  data-pservice="' + pservice + '" ></td><td style="display: none" class="chartered"  data-chartered="' + chartered + '" ></td><td style="display: none" class="cduration"  data-cduration="' + cduration + '" ></td><td style="display: none" class="register"  data-register="' + register + '" ></td><td style="display: none" class="mra"  data-mra="' + mra + '" ></td><td style="display: none" class="invited"  data-invited="' + invited + '" ></td><td style="display: none" class="member text-align-center"  data-member="' + member + '" ></td><td class="text-align-center"><label class="container-checkbox pull-right" id="checklabel-' + count + '"><input id ="' + count + '" type="checkbox" checked="checked"><span class="checkmark"></span></label></td></tr>');
                            $('#counter').text(count);
                        }
                    }
                });
...
//        $('.price-comp-value').text(price_comp);
    ...
    $(document).on("change", ".container-checkbox input:checkbox", function (e) {
